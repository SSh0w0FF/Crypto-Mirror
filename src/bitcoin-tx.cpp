...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s Bitcoin Mirror-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Bitcoin Mirror-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Bitcoin Mirror transaction") + "\n" +
              "  Bitcoin Mirror-tx [options] -create [commands]   " + _("Create hex-encoded Bitcoin Mirror transaction") + "\n" +
              "\n";
