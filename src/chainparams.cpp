...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.Bitcoin Mirror.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.Bitcoin Mirrortools.com", true);
        vSeeds.emplace_back("dnsseed.Bitcoin Mirrorpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.Bitcoin Mirrortools.com", true);
        vSeeds.emplace_back("seed-b.Bitcoin Mirror.loshan.co.uk", true);
