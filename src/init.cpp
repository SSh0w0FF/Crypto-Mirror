...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Bitcoin Mirror-project/Bitcoin Mirror>";
    const std::string URL_WEBSITE = "<https://Bitcoin Mirror.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Bitcoin Mirror version %s\n", FormatFullVersion());
}
